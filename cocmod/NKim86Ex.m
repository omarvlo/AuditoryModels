...
% subplot(5,1,1)
% plot(x,k1)
% title('Parámetro k1'), xlabel('x'), ylabel('k1')
% subplot(5,1,2)
% plot(x,c1)
% title('Parámetro c1'), xlabel('x'), ylabel('c1')
% subplot(5,1,3)
% plot(x,m1)
% title('Parámetro m1'), xlabel('x'), ylabel('m1')
% subplot(5,1,4)
% plot(x,k2)
% title('Parámetro k2'), xlabel('x'), ylabel('k2')
% subplot(5,1,5)
% plot(x,c2)
% title('Parámetro c2'), xlabel('x'), ylabel('c2')

% figure(2)
% subplot(5,1,1)
% plot(x,m2)
% title('Parámetro m2'), xlabel('x'), ylabel('m2')
% subplot(5,1,2)
% plot(x,k3)
% title('Parámetro k3'), xlabel('x'), ylabel('k3')
% subplot(5,1,3)
% plot(x,c3)
% title('Parámetro c3'), xlabel('x'), ylabel('c3')
% subplot(5,1,4)
% plot(x,k4)
% title('Parámetro k4'), xlabel('x'), ylabel('k4')
% subplot(5,1,5)
% plot(x,c4)
% title('Parámetro c4'), xlabel('x'), ylabel('c4')
